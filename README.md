...
[`SECURITY.md`](SECURITY.md) for the secret-handling model. See also
[`HANDOVER.md`](HANDOVER.md) for what this specific copy is and how it
differs from the original build it was forked from.
