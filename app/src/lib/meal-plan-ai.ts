...
import { SKATE_DAY, NORMAL_DAY } from "./seed-plan";
...
- Sat + Sun = skate days (kcal_target ${profile.nutrition_targets.total_kcal_target_skate_day}, ~${SKATE_DAY.carb_g_target}g carbs). Pre-skate fuel breakfast (cuscuz/banana/mel/peanut butter type), electrolytes mid-morning, post-skate recovery lunch (fast carbs + whey).
- Mon–Fri = work days (kcal_target ${profile.nutrition_targets.total_kcal_target_off_day}, protein ${profile.nutrition_targets.protein_g_per_day}g, ~${NORMAL_DAY.carb_g_target}g carbs).
...
- Sáb + Dom = skate days (kcal_target ${profile.nutrition_targets.total_kcal_target_skate_day}, ~${SKATE_DAY.carb_g_target}g carbo). Café da manhã pré-skate (cuscuz/banana/mel/pasta de amendoim), eletrólito mid-manhã, almoço pós-skate recovery (carbo rápido + whey).
- Seg–Sex = dias de trabalho (kcal_target ${profile.nutrition_targets.total_kcal_target_off_day}, proteína ${profile.nutrition_targets.protein_g_per_day}g, ~${NORMAL_DAY.carb_g_target}g carbo).
