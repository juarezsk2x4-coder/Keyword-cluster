...
const pt: Dict = {
  ...
  insight: {
    ...
    skate_syncope_risk: "Uso recente + dia de alta intensidade hoje: risco maior de síncope (Mg baixo + desidratação prévia). Hidratação extra (+1L), eletrólito antes de sair, considera intensidade mais leve hoje.",
...
const en: Dict = {
  ...
  insight: {
    ...
    skate_syncope_risk: "Recent use + a high-intensity day today: higher syncope risk (low Mg + prior dehydration). Extra hydration (+1L), electrolytes before heading out, consider a lighter intensity today.",
