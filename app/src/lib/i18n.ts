...
const pt: Dict = {
  ...
  insight: {
    ...
    post_substance: "Estimulante nos últimos 2 dias: hidratação +1L, magnésio (cacau/castanhas/folhas), evita álcool, prioriza sono.",
    post_alcohol: "Álcool nos últimos 2 dias: hidratação extra + B-complex (ovo/folhas/lentilha).",
...
const en: Dict = {
  ...
  insight: {
    ...
    post_substance: "Stimulant in the last 2 days: hydration +1L, magnesium (cacao/nuts/greens), avoid alcohol, prioritize sleep.",
    post_alcohol: "Alcohol in the last 2 days: extra hydration + B-complex (egg/greens/lentil).",
